...
const mushroomSpecies = [
  {
    ...
    statements: [
      ...
      'My stem is holllow and I do not have gills'
    ]
  },
  {
    name: 'Chanterelle',
  ...
  },
  {
    ...
    statements: [
      ...
      'Sometimes I lokk deformed and lumpy',
...
document.getElementById('field').addEventListener('click', pickMushroom);
...
function endGame() {
  ...
  // You can add additional elements or styling here if needed
}
 function resetGame() {
   displayedStatements = [];
   mushroomCounts = {};
